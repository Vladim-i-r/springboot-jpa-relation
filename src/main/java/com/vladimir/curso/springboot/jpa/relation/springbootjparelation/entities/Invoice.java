...
public class Invoice {
    ...
    public String toString() {
        return "{id=" + id + ", description=" + description + ", total=" + total + "}";  //borramos el cliente de aqui para no entrar en ciclo infinito en el toString de Cliente
                                                                                        // Si no, al llamar al cliente mandara llamar los invoices, y los invoices al cliente sucesivamente
    }
